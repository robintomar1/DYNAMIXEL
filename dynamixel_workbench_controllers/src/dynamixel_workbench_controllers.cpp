...
/* check the number of arguments entered and set the values of port name and baud rate*/
...
/*the following lines check different communication parameters calling the pre defined dynamixel functions 
 *they take input from the YAML file given as input and tast these parameters for each motor entry
 *if any of the motor defined in yaml file doesnt work properly it produces an error*/
